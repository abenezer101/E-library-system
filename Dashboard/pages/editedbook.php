                            ...
                            <div class="row">
								...
								<?php
									include 'dbconnect.php';
										...
										$id=$_POST['id'];
										//update query
										$qry = "update books set title='$title', publisher='$publisher', year_published='$year_published', thumbnail='Dashboard/pages/$thumbnail', pdf_path='Dashboard/pages/$pdf_path' where id='$id'";
