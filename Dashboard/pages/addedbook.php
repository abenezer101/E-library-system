                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="index.php" method="post">
                                        <?php 
                                            ...
                                            $qry = "INSERT INTO books (id,title, publisher, year_published, thumbnail, pdf_path) VALUES ('$book_id','$title', '$publisher', '$year_published', 'Dashboard/pages/$thumbnail_path', 'Dashboard/pages/$pdf_path')";
