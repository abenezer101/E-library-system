                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="announce.php" enctype="multipart/form-data" method="post">


                                        <div class="form-group">
                                            <label>Enter Name of Author</label>
                                            <p>Enter Max: 20 Characters</p>
                                            <input class="form-control" placeholder="Enter Author's Name" type="text" name="Author_name"  maxlength="20" required>
                                        </div>          

                                        <div class="form-group">
                                            <label>Enter Announcement Title</label>
                                            <p>Enter Max: 45 Characters</p>
                                            <input class="form-control" type="text" placeholder="Announcement Title" name="title" maxlength="45"required>
                                        </div>

                                        <div class="form-group">
                                            <label>Enter Announcement Text</label>
                                            <p>Enter Max: 950 Characters</p>
                                            <textarea class="form-control" rows="4" type="text" name="message"  maxlength="950" required></textarea>
                                        </div>
